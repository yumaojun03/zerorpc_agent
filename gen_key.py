...
def generate_certificates(base_dir):
    ...
    Args:
        base_dir: the base directory to storage public_keys directory and private_keys directory.
        """
    ...
    # display the key file path
    print "SERVER PUBLIC KEY: %s" % server_public_file
    print "SERVER SECRET KEY: %s" % server_secret_file
    print "CLIENT PUBLIC KEY: %s" % client_public_file
    print "CLIENT SECRET KEY: %s" % client_secret_file
